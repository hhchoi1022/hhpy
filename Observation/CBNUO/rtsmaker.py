...
# Modified by Hyeonho, Choi, 2022 for better performance especially processing speed

#%%
def rtsmaker(observatory        = 'SSO',
             save_path          = '/data1/obsroutine/LSGT/2024',
             obspath            = "/data1/obsroutine/obs_location.txt",
             catpath            = '/data1/obsroutine/LSGT/alltarget_lsgt210101.dat',
             start              = '2024/01/01',
             end                = '2025/01/01',
             headname           = 'IMSNG',
             altlimit           = 30.,
    ...
    for i in range(int(endmjd-startmjd)):
        ...
        dst         = tz.localize(onedaydt, is_dst = True).dst()
