...
class mainObserver(mainConfig):
    ...
    **kwargs : optional
    ...
    def sun_risetime(self,
        ...
        if not isinstance(utctimes, Time):
            utctimes = Time(utctimes)
        return self._observer.sun_rise_time(utctimes, which = mode, horizon = horizon * u.deg, n_grid_points = n_grid_points)
    ...
    def sun_settime(self,
        ...
        if not isinstance(utctimes, Time):
            utctimes = Time(utctimes)
        return self._observer.sun_set_time(utctimes, which = mode, horizon = horizon * u.deg, n_grid_points = n_grid_points)
    ...
    def moon_risetime(self,
        ...
        if not isinstance(utctimes, Time):
            utctimes = Time(utctimes)
        return self._observer.moon_rise_time(utctimes, which = mode, horizon = horizon * u.deg, n_grid_points = n_grid_points)
    ...
    def moon_settime(self,
        ...
        if not isinstance(utctimes, Time):
            utctimes = Time(utctimes)
        return self._observer.moon_set_time(utctimes, which = mode, horizon = horizon * u.deg, n_grid_points = n_grid_points)
